...
namespace SilhouetteEditor
{
    ...
    {
        private const int _CameraMovingSpeed = 2000;
        ...
        private static Color _ColorParticles = new Color(0, 0, 255, 255);
        public static Color ColorParticles { get { return _ColorParticles; } }
