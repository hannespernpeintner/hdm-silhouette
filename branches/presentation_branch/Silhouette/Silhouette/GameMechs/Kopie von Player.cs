...
namespace Silhouette.GameMechs
{
    public class Player : DrawableLevelObject
    {
        ...
        public static int SLOWDOWNTIME = 150;

        public float tempRotation;
        public int resetTimer;
        public int slowDownTimer;
        public bool slowDownTimerStarted;
        ...
        public Vector2 trueOldPosition;
        ...
        public override void LoadContent()
        {
            ...
            landing_left.Load(8, "Sprites/Player/landing_left_", 1.2f, false);
            landing_right.Load(8, "Sprites/Player/landing_right_", 1.2f, false);
            //1,5
            ...
            runStopping_left.Load(8, "Sprites/Player/walkStop_left_", 1.40f, false);
            runStopping_right.Load(8, "Sprites/Player/walkStop_right_", 1.40f, false);
            ...
            charRect = FixtureManager.CreateCapsule((idle_left.pictures[0].Height / 5) / Level.PixelPerMeter, 55, position, BodyType.Dynamic, 1);
            ...
            sRect = FixtureManager.CreateRectangle(100, 60, new Vector2(position.X, position.Y + 70), BodyType.Dynamic, 0);
            ...
            foreach (Fixture fix in charRect) {
                fix.OnCollision += this.OnCollision;
                fix.OnSeparation += this.OnSeperation;
            }
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (!isDying && !isUncontrollableMoving)
            {
        ...
        public void UpdatePositions()
        {
            ...
            sRect.Body.Position = charRect[0].Body.Position + new Vector2(0, 80 / Level.PixelPerMeter);
            nRect.Body.Position = charRect[0].Body.Position + new Vector2(0, -105 / Level.PixelPerMeter);
        ...
        private void UpdateControls(GameTime gameTime)
        {
            ...
            {
                charRect[0].Friction = 10;
            }

            else { charRect[0].Friction = 5; }

            oldState = kState;
            oldPosition = charRect[0].Body.Position;
            trueOldPosition = position;
        }
...
/*
        ...
        private void hang()
        {
            ...
            if ((activeAnimation == hang_right || activeAnimation == hang_left) && activeAnimation.activeFrameNumber < activeAnimation.amount - 1)
            {
                ...
                if (charRect[0].Body.Position.Y/Level.PixelPerMeter < maxHeight)
                {
        ...
        public void UpdateNextAnimation()
        {
                                ...
                                activeAnimation != idlec_right))
            {
                if (facing == 0)
                {
                    ...
                    activeAnimation.activeFrameNumber = 0;
                    activeAnimation.start();
                    nextAnimation = runStopping_left;
                }
                else
                {
                    activeAnimation = running_right;
                    activeAnimation.activeFrameNumber = 0;
                    activeAnimation.start();
                    nextAnimation = runStopping_right;
                }
            }
            ...
            if (activeAnimation.activeFrameNumber == activeAnimation.amount - 1 && isLanding && (activeAnimation == landing_left || activeAnimation == landing_right))
            {
                isFalling = false;
                isSlowingDown = false;
                isLanding = false;
                charRect[0].Body.ResetDynamics();
        ...
        public void ObserveMovement()
        {
            ...
            if (isJumping && oldPosition.Y < charRect[0].Body.Position.Y && (!rectTouching || !sRectTouching))
            {
                isIdle = false;
                isFalling = true;
                isRunning = false;
            ...
            if (movement.Y > 1.50f && !isFalling && !isLanding)
            {
        ...
        private void ObserveTimer(GameTime gameTime)
        {
            ...
            if (isSlowingDown)
            {
                ...
                {
                    charRect[0].Body.ApplyForce(new Vector2(-movement.X / 10, 0));
        ...
        public bool OnCollision(Fixture fixtureA, Fixture fixtureB, Contact contact)
        {
            ...
            if (isFalling && (activeAnimation != landing_right && activeAnimation != landing_left) && !fixtureB.IsSensor && kState.GetPressedKeys().Length == 0 && sRectTouching)
            {
                isFalling = false;
                isJumping = false;
                isIdle = true;
            ...
            else if ((isFalling || isLanding) && kState.IsKeyDown(Keys.Left) && !fixtureB.IsSensor && sRectTouching)
            {
                isFalling = false;
                isJumping = false;
                isIdle = false;
            ...
            else if ((isFalling || isLanding) && kState.IsKeyDown(Keys.Right) && !fixtureB.IsSensor && sRectTouching)
            {
                isFalling = false;
                isJumping = false;
                isIdle = false;
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(FontManager.Arial, charRect[0].Body.Position.ToString(), position + new Vector2(300, 120), Color.Black);
