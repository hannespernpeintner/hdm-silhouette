...
{
    /* Sascha:
     * DebugView der Physikengine. Zeigt an was genau in der Physikengine passiert.
     * Sie stellt Bodies, Fixtures, Joints etc. dar.
    */
    public class DebugViewXNA : DebugView, IDisposable
    {
        ...
        //Sascha: Zeichnet Shapes, Joints, etc auf den Bildschirm
        ...
        {
            //Sascha: Gibt Debugdaten auf dem Bildschirm aus
        ...
        {
            //Sascha: Lädt alle relevanten Assets z.B. Fonts
